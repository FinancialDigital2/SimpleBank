...
public class DacaDrwgPrcsModule {
	
	@Autowired
	IRPB1000Module	iRPB1000Module;
	
	@Autowired
	DacaDrwgRfctModule dacaDrwgRfctModule;

	@Autowired
	TrDetlRfctModule trDetlRfctModule;
	
	public DacaDrwgPrcsModuleOutVO dacaDrwgPrcsModule(DacaDrwgPrcsModuleInVO inData) throws Exception{
		log.debug("[Start] "+ getClass().getName());
		/*************************************************************
		 * Declare Var
		 *************************************************************/
		
		DacaDrwgPrcsModuleOutVO out = new DacaDrwgPrcsModuleOutVO();
		try
		{	
			/********************************************************************
			 *  입력값 체크
		    ...
		    ***********************************************************************/
			...
			dacaDrwgRfctModuleInVO.setAcno(inData.getAcno());
			dacaDrwgRfctModuleInVO.setDrwg_amt(inData.getTot_tr_amt());
			
			DacaDrwgRfctModuleOutVO drrmOutVo =  dacaDrwgRfctModule.dacaDrwgRfctModule(dacaDrwgRfctModuleInVO);
	 ...
	 * @throws Exception
	 */
	private void f_init_Check(DacaDrwgPrcsModuleInVO inData) throws Exception {
