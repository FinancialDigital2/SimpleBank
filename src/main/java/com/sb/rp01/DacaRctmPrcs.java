...
import com.sb.module.DacaRctmPrcsModule;
import com.sb.module.DacaRctmPrcsModuleInVO;
import com.sb.module.DacaRctmPrcsModuleOutVO;
...
public class DacaRctmPrcs {
	...
	@Autowired
	DacaRctmPrcsModule dacaRctmPrcsModule;
	
	public DacaRctmPrcsOutVO dacaRctmPrcs(DacaRctmPrcsInVO inData) throws Exception{
		log.debug("[Start] "+ getClass().getName());
		/*************************************************************
		 * Declare Var
		 *************************************************************/
		DacaRctmPrcsOutVO out = new DacaRctmPrcsOutVO();
		/*일자설정*/
		String today = "";
		...
		{	
			...
			DacaRctmPrcsModuleInVO drpmInVO =	new DacaRctmPrcsModuleInVO(); 
			DacaRctmPrcsModuleOutVO drpmOutVO =	null;
			...
			drpmInVO.setSyns_cd("001");   /*적요코드 001: 입금 */
			
			drpmOutVO = dacaRctmPrcsModule.dacaRctmPrcsModule(drpmInVO);
	 ...
	 * @throws Exception
	 */
	private void f_init_Check(DacaRctmPrcsInVO inData) throws Exception {
